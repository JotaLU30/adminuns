...
<center>
<h2 class="h2">Modulo de Alertas</h2>
</center>
  <br>
  <small><h4 class="h2">Ultimas Alertas</h4></small> &nbsp;&nbsp;&nbsp;<button type="button" class="btn-uns">Agregar Nueva</button>
  <div class="table-responsive">
    <table class="table table-striped table-sm">
      <thead>
        <tr>
          <th>#</th>
          <th>Titulo de la alerta</th>
          <th>Descripcion</th>
          <th>Creado por </th>
