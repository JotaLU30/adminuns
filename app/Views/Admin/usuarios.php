...
<center>
<h2 class="h2">Modulo de Usuarios</h2>
</center>
  <br>
  <small><h4 class="h2">Usuarios Registrados</h4></small> &nbsp;&nbsp;&nbsp;<button type="button" class="btn-uns" data-toggle="modal" data-target="#nuevaalerta">+ Agregar Nuevo</button>&nbsp;&nbsp;<button type="button" class="btn-uns" data-toggle="modal" data-target="#nuevaalerta">- Elimiar Usuario</button>&nbsp;&nbsp;<button type="button" class="btn-uns" data-toggle="modal" data-target="#nuevaalerta">Editar Usuario</button>
